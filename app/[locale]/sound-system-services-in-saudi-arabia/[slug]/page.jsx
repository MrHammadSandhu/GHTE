...
import { INTERCOM_SYSTEM_DATA, PA_SOUND_SYSTEM_DATA, VOICE_EVACUATION_SYSTEM_DATA } from "@/data/sound-system-page-data";
...
const GeneratorTypeDetailPage = ({ params }) => {
  ...
  switch (slug) {
    case "pa-systems":
      selectedData = PA_SOUND_SYSTEM_DATA;
      typeKey = "PASoundSystemData";
      break;
    case "voice-evacuation-systems":
      selectedData = VOICE_EVACUATION_SYSTEM_DATA;
      typeKey = "VoiceEvacuationSystemData";
      break;
    case "intercom-systems":
      selectedData = INTERCOM_SYSTEM_DATA;
      typeKey = "IntercomSystemData";
      break;
    default:
      selectedData = PA_SOUND_SYSTEM_DATA;
      typeKey = "PASoundSystemData";
