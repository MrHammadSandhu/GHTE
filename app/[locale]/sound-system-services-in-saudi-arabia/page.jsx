...
import { SOUND_SYSTEM_PAGE_DATA } from "@/data/sound-system-page-data";

export default async function SoundSystemPage({ params: { locale } }) {
  const {
    metadata,
    pageHeader,
    sidebarCategories,
    ...
    productData,
    SOUND_SYSTEM_TYPES,
    SOUND_SYSTEM_APPLICATIONS,
    SOUND_SYSTEM_FAQS,
    whychooseus,
    sidebar,
  } = SOUND_SYSTEM_PAGE_DATA;
  ...
  return (
    <>
      <SEOHead
        ...
        locale={locale}
        pageUrl="/sound-system-services-saudi-arabia"
      />
      ...
      <section className="container mx-auto px-4 sm:px-6 md:px-4 xl:px-12 py-8 sm:py-12 md:py-16 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          <div className="lg:col-span-2 space-y-10">
            <ImageSlider
              images={soundSystemData.images}
              altText={"Sound System Images"}
            />
            <Header
            ...
            >
              ...
              <Description>{soundSystemData.description}</Description>
            </Header>
        ...
        <ProductTypeCard ProductTypes={SOUND_SYSTEM_TYPES} />
        <IndustryApplications applications={SOUND_SYSTEM_APPLICATIONS} />
        <WhyChooseUs whychooseus={whychooseus} />
        <FaqAccordion faqs={SOUND_SYSTEM_FAQS.details} />
      </section>
    </>
  );
}
