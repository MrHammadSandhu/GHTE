// app/[locale]/cctv-solutions-saudi-arabia/page.tsx
...
import { CCTV_PAGE_DATA } from "@/data/cctv-page-data";

export default async function CCTVPage({ params: { locale } }) {
  const {
    metadata,
    pageHeader,
    sidebarCategories,
  ...
  return (
    <>
      <SEOHead
        ...
        locale={locale}
        pageUrl="/cctv-solutions-saudi-arabia"
      />
      ...
      <section className="container mx-auto px-4 sm:px-6 md:px-4 xl:px-12 py-8 sm:py-12 md:py-16 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          <div className="lg:col-span-2 space-y-10">
            <ImageSlider images={CCTVData.images} altText={"CCTV Images"} />
            <Header
            ...
            >
              ...
              <Description>{CCTVData.description}</Description>
            </Header>
        ...
        <ProductTypeCard ProductTypes={CCTV_TYPES} />
        <IndustryApplications applications={CCTV_APPLICATIONS} />
        <WhyChooseUs whychooseus={whychooseus} />
        <FaqAccordion faqs={CCTV_FAQS.details} />
      </section>
    </>
  );
}
